      ...
      {mounted && (
        <GuiProvider colorScheme={ColorSchemeMode.Dark} ref={styleRef}>
          {styleRef.current && isMaxSmallDevice && (
            <div
              className="absolute text-body h-lvh max-h-lvh w-screen max-w-screen bg-background-200 flex flex-col justify-between py-8 px-8 transition-position overflow-hidden"
